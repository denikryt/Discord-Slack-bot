...
SLACK_CHANNEL_GUEST_ROOM = os.environ.get('SLACK_CHANNEL_GUEST_ROOM')
SLACK_CHANNEL_NEWBIES = os.environ.get('SLACK_CHANNEL_NEWBIES')
SLACK_CHANNEL_QUESTIONS = os.environ.get('SLACK_CHANNEL_QUESTIONS')
...
DISCORD_CHANNEL_GUEST_ROOM = os.environ.get('DISCORD_CHANNEL_GUEST_ROOM')
DISCORD_CHANNEL_NEWBIES = os.environ.get('DISCORD_CHANNEL_NEWBIES')
DISCORD_CHANNEL_QUESTIONS = os.environ.get('DISCORD_CHANNEL_QUESTIONS')
...
SLACK_CHANNELS_DICT = {
    ...
    SLACK_CHANNEL_GUEST_ROOM:DISCORD_CHANNEL_GUEST_ROOM,
    SLACK_CHANNEL_NEWBIES:DISCORD_CHANNEL_NEWBIES,
    SLACK_CHANNEL_QUESTIONS:DISCORD_CHANNEL_QUESTIONS,
    }
...
DISCORD_CHANNELS_DICT = {
    ...
    DISCORD_CHANNEL_GUEST_ROOM:SLACK_CHANNEL_GUEST_ROOM,
    DISCORD_CHANNEL_NEWBIES:SLACK_CHANNEL_NEWBIES,
    DISCORD_CHANNEL_QUESTIONS:SLACK_CHANNEL_QUESTIONS,
    }
